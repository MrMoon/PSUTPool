...
public class RequestRide {
    ...
    public Map<String, Object> toRequestMap(LatLng customerLocation, LatLng driverLocation, String driverPhoneNumber) {
        ...
        requestMap.put(CUSTOMER_PHONE_NUMBER, customer.getPhoneNumber());
